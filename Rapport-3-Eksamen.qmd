...
## Oppgave 1
- Forklar estimate, SE, t-verdi og p-verdi fra regresjonsmodellene m1 og m2
...
## Oppgave 2
- Diskusjon av forskjellene mellom m1 og m2
...
## Oppgave 3
- Hvorfor bruker vi det skyggelagte området i t-fordelingen?
...
## Oppgave 4
- Beregning av standardavvik for estimatvariabelen og gjennomsnittlig standardfeil for utvalgsstørrelser 8 og 40
...
## Oppgave 5
- Tolkning av histogram av p-verdier for ulike utvalgsstørrelser og deres betydning for statistisk styrke
...
## Oppgave 6
- Antall studier med statistisk signifikante effekter basert på spesifisert signifikansnivå
...
## Oppgave 7
- Beregning av styrken i en en-utvalgs t-test ved hjelp av pwr-pakken med effektstørrelse 1.5/3
...
## Oppgave 8
- Antall studier med 'falske positive' resultater ved et signifikansnivå på 5 % i gjentatte studier
